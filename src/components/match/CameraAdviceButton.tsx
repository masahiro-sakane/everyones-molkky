  ...
  return (
    <>
      <button
        type="button"
        onClick={handleOpen}
        className="inline-flex items-center gap-1 px-2.5 py-1.5 rounded-md bg-brand-600 text-neutral-0 text-xs font-semibold hover:bg-brand-700 transition-colors shrink-0"
